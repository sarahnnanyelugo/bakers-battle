      ...
      <div className="d-md-flex col-md-10 offset-md-1 mobile-padding">
        <div className="col-md-5">
          ...
          <p>
            ...
            it's peak. This is an ample opportunity for bakers to compete with
            and learn from each other on the battle field ... until now. Come
            see why we think Kitchen Disaster's bakers are the best!
          </p>
        </div>
