  ...
  return (
    <>
      ...
      >
        ...
        <Modal.Body className="registration-form">
          {" "}
          <div>
            <div className="form ">
              <form className="col-md-12">
                <div className="d-flex">
                  <div style={{ flexGrow: 1 }} className="col-12 col-md-6">
                    ...
                    <p>
                      <span>Judging:</span> There will be 3 Judges and winner
                      will be posted at 3pm(WAT).
                    </p>
                  </div>
              ...
              <Accordion defaultActiveKey="0" className="col-md-7">
                <Accordion.Item eventKey="0">
                  ...
                  <Accordion.Body>
                    <ul className="rules">
                      <li>
                        Professional bakers are not allowed to participate.
                      </li>
                      <li>
                    ...
                    <ul className="rules">
                      ...
                      <li>
                        ...
                        on such event. I participate in this voluntarily and
                        with full knowledge of the inherent risks.
                      </li>
                      <li>
                        {" "}
                        ...
                        employees arising from my participation, including but
