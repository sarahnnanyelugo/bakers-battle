      ...
      <div className="d-md-flex about-div col-md-10 offset-md-1">
        <div className="col-md-6 mobile-padding">
          <div className="col-md-11">
            ...
            <p>
              At the end of the competition, there shall emerge three winners.
              There shall be prices for all three and off course consolation
              prices for all participants. category.
              <Link to={"/about"}>
