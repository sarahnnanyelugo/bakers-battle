...
import Sponsor1 from "../../assets/images/sponsor4.png";
import Sponsor1 from "../../assets/images/sponsor5.png";
import Sponsor1 from "../../assets/images/sponsor6.png";
  ...
  return (
    <>
      ...
      <div className="col-md-12 sponsors-div">
        <div className="col-md-10 offset-md-1  d-md-flex row row-cols-2 row-cols-lg-4 g-2 g-lg-3">
          <div className="col">
