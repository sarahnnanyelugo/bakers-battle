      ...
      <div className="d-md-flex about-div col-md-10 offset-md-1">
        <div className="col-md-6 mobile-padding">
          <div className="col-md-11">
            ...
            <h3>The Contest</h3>
            <p>
              Join us on November 2024 at a renowed bakery empire in Lagos State
              to discover whose bakes have won! The event will be free and open
              to the public.
            </p>
            <p>
              ate Attendance at the event is free, and passes for tastings after
