...
export const Home = () => {
  ...
  return (
    <div class="stretched device-xl">
      <div
        id="wrapper"
        style="background-color: rgb(222, 242, 249); border-top: 24px solid rgb(220, 114, 124); animation-duration: 1500ms; opacity: 1;"
        class="clearfix"
      >
            ...
            <div class="main-logo">
              <a href="https://chicagosbestbaker.com">
                <img
                  ...
                  style="padding-top:15px; padding-left:15px; max-width:225px;"
                />
              </a>
            </div>
        ...
        <section
          ...
          style="border-bottom: 24px solid rgb(220, 114, 124); height: 187px;"
        >
          <div
        ...
        <div
          ...
          style="border-bottom:24px solid #dc727c; position: relative;"
        >
          <div class="banner">Chicago's Only Amateur Baking Contest</div>
