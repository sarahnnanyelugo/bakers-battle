      ...
      <div className="col-md-10 offset-md-1 d-md-flex about-start">
        ...
        <div className="col-md-6">
          ...
          <p>
            ...
            we're thrilled to have you as part of our community. Let's embrace
            the beautiful mess that is cooking together and turn every kitchen
            disaster into a delightful adventure.
          </p>
          <img
            src={Bake}
            // className="col-md-11"
