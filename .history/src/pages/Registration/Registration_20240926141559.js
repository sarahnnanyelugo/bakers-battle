              ...
              <Accordion.Body>
                ...
                <ul className="rules">
                  ...
                  <li>
                    {" "}
                    <input type="checkbox" />
                    Attendees participate at their own risk. The event
                    organizers will not be held responsible for any incidents,
                    accidents, injuries, theft, loss, or damage that may occur
