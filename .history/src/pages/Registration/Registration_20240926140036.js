          ...
          <form className="col-md-12">
            <div className="d-flex">
              <div style={{ flexGrow: 1 }} className="col-12 col-md-6">
                ...
                <p>
                  <span>Registration</span>:November 2024
                </p>{" "}
                <p>
            ...
            <Accordion.Item eventKey="0">
              ...
              <Accordion.Body>
                ...
                <ul className="rules">
                  ...
                  <li>
                    By registering, you consent to your provided pictures and
                    videos being used for advert and or promotional purposes by
                    Kitchen Disaster without compensation or permission.{" "}
                  </li>
                </ul>
              </Accordion.Body>
            </Accordion.Item>
