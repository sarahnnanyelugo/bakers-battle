      ...
      <div className="registration-form">
        <div className="form col-md-8 offset-md-2">
          ...
          <ul>
            ...
            <li>
              I understand, appreciate and acknowledge that property damage and
              injuries are common on such event. I participate in this
              voluntarily and with full knowledge of the inherent risks.
            </li>
            <li>
              I hereby release any and all rights that either my assigns or I
              may have against the contest organization, the supervisors, hosts
              agents or employees arising from my participation, including but
              not limited to property damage and injuries.
            </li>
          </ul>
          <center>
